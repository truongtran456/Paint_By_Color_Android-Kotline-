...
public abstract class CameraBridgeViewBase extends SurfaceView implements SurfaceHolder.Callback {
    ...
    protected boolean mCameraFrameReady = false;
    protected boolean mStopThread = false;
    protected int mChainIdx = 0;
    ...
    public interface CvCameraViewListener {
        /**
         * This method is invoked when camera preview has started. After this method is called
    ...
    protected void deliverAndDrawFrame(CvCameraViewFrame frame) {
        ...
        if (modified != null) {
            try {
                ...
                Log.e(TAG, "Bitmap type: " + mCacheBitmap.getConfig());
    ...
    protected class CameraWorker implements Runnable {
        ...
        public void run() {
            do {
                ...
                synchronized (CameraBridgeViewBase.this) {
                    try {
                        while (!mCameraFrameReady && !mStopThread) {
                            CameraBridgeViewBase.this.wait();
                        }
                ...
                if (!mStopThread && hasFrame) {
                    if (!mFrameChain[1 - mChainIdx].empty()) {
                        CvCameraViewFrame frame = new CvCameraViewFrame() {
                            @Override
                            public Mat rgba() {
                                return mFrameChain[1 - mChainIdx];
                            }
                            ...
                            public Mat gray() {
                                ...
                                Mat gray = new Mat();
                                if (mFrameChain[1 - mChainIdx].channels() == 4) {
                                    Imgproc.cvtColor(mFrameChain[1 - mChainIdx], gray, Imgproc.COLOR_RGBA2GRAY);
                                } else if (mFrameChain[1 - mChainIdx].channels() == 3) {
                                    Imgproc.cvtColor(mFrameChain[1 - mChainIdx], gray, Imgproc.COLOR_RGB2GRAY);
                                } else {
                                    mFrameChain[1 - mChainIdx].copyTo(gray);
                                }
                                return gray;
                            }
